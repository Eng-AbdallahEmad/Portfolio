...
ScrollReveal().reveal('.skills-description, .Services-description, .contact-card, .team-swiper, .contact-left h2', { delay: 700, origin: 'left', });
...
//SC Loading Screan
const loader = document.querySelector(".container-sp");
